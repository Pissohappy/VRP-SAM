...
class  SAM_pred(nn.Module):
    def __init__(self, ):
        super().__init__()
        self.sam_model = sam_model_registry['vit_h']('/home/user/zhangdantong/VRP-SAM-main/pretrained/sam_vit_h_4b8939.pth')
        self.sam_model.eval()
    ...
    def get_feat_from_np(self, query_img, query_name, protos):
        np_feat_path = '/home/user/zhangdantong/VRP-SAM-main/feats_np/coco/'
