...
def train(args, epoch, model, sam_model, dataloader, optimizer, scheduler, training):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        protos, _ = model(args.condition, batch['query_img'], batch['support_imgs'].squeeze(1), batch['support_masks'].squeeze(1), batch['class_id'], training)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local-rank', '--local-rank', dest='local_rank', type=int, default=-1,
    ...
    optimizer = optim.AdamW([
        ...
        {'params': model.module.confidence_head.parameters(), "lr": args.lr},
